...
const PostJob = () => {
    ...
    useEffect(() => {
        if (isEditMode && job) {
            ...
            setValue('salary', job.salary / 100000); // Convert to LPA for display
    ...
    const onSubmit = (data: JobFormData) => {
        ...
        const jobData = {
            ...data,
            salary: data.salary * 100000, // Convert LPA to absolute number
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={8}
                                disabled={isPending}
                                className={`w-full px-4 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-black focus:border-black outline-none text-sm resize-y ${errors.description ? 'border-red-500' : ''
                                    }`}
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={6}
                                disabled={isPending}
                                className="w-full px-4 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-black focus:border-black outline-none text-sm resize-"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                    Annual Salary (LPA) {isEditMode && <span className="text-xs text-gray-500">(Locked)</span>}
                                </label>
                                <input
